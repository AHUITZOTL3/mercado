<?php include_once("conexion.php"); 
	...
	mysqli_query($conexion, "INSERT INTO usuarios(Usuario,Contraseña,id_rol, id_pro) VALUES('$nombre','$correo','$telefono')");
...
mysqli_query($conn, "DELETE FROM usuarios WHERE id=$cod");
