...
$sql ="SELECT ID , usuario FROM administrador WHERE ID = '$iduser";
...
<body>
	...
	if(isset($_GET['ID'])){
		$query = mysqli_query($conexion, "SELECT * FROM administrador WHERE ID = '".$_GET['ID']."'");
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles">Bienvenido: <?php echo $_SESSION['usuario'] ?></figcaption>
				</figure>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu"><img src="../img/iconcertificate.png" alt="bir">
						<!--<i class="zmdi zmdi-case zmdi-hc-fw"></i>--> Certificados <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
					<ul class="list-unstyled full-box">
						<li>
							<a href="certificadoadmi.php"><img src="../img/certifi.png" alt="bir"><!--<i class="zmdi zmdi-timer zmdi-hc-fw"></i>--> Certificados</a>
						</li>
						<!--<li>
							<a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Subject</a>
						</li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><img src="../img/ecology.png" alt="bir">Sistema <small>Contenido</small><img src="../img/organicon.png" alt="bir"></h1>
			</div>
		</div>
