...
<body>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><img src="../img/cv.png" alt="bir"><!--<i class="zmdi zmdi-male-female zmdi-hc-fw"></i>--> Certificado <small>administrar</small></h1>
			</div>
			<p class="lead">En esta parte puedes agregar y editar a los certificados que contiene el sistema!</p>
		</div>
		<div class="container-fluid">
			<!--<div class="row">
				<div class="col-xs-12">
