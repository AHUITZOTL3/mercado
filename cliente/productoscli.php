...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<a href="regisproducli.php">Registrar</a></td>
		</form>
		...
		<table>	
			...
			<input type="submit" value="Buscar" name="btnbuscar"><input type="text" name="txtbuscar" id="cajabuscar" placeholder="&#128270;Ingresar nombre de usuario">
				...
				<tr><th colspan="5"><h1>LISTAR PRODUCTOS</h1><th><a style="font-weight: normal; font-size: 14px;" onclick="abrirform()">Agregar</a></th></tr>
				<tr>
				<th>Id</th>
				<th>Nombre</th>
				<th>Cantidad KG</th>
