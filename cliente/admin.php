			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="representative.php"><img src="../img/peo.png" alt="bir"><!--<i class="zmdi zmdi-male-female zmdi-hc-fw">--></i> Usuarios</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="registration.php"><img src="../img/sbasket.png" alt="bir"><!--<i class="zmdi zmdi-money-box zmdi-hc-fw"></i>--> Mercados</a>
						</li>
						<!--<li>
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="school.php"><img src="../img/ubi.png" alt="bir"><!--<i class="zmdi zmdi-balance zmdi-hc-fw"></i>--> Ubicacion</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="subject.php"><img src="../img/material.png" alt="bir"><!--<i class="zmdi zmdi-balance zmdi-hc-fw"></i>--> Productos</a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Admin <small>Administrador</small></h1>
			</div>
